function main()
{
    ...
    {
        var id = faces[i];
        var p0 = parseInt( 255 * ( scalars[ id[0] ] - 0.1 ) / 0.7 );
        var p1 = parseInt( 255 * ( scalars[ id[1] ] - 0.1 ) / 0.7 );
        var p2 = parseInt( 255 * ( scalars[ id[2] ] - 0.1 ) / 0.7 );
        var C0 = new THREE.Color().setHex( cmap[ p0 ][1] );
        var C1 = new THREE.Color().setHex( cmap[ p1 ][1] );
        var C2 = new THREE.Color().setHex( cmap[ p2 ][1] );
