function Isosurfaces( volume, isovalue, colors, shader )
{
        ...
        for ( var y = 0; y < volume.resolution.y - 1; y++ )
        {
            for ( var x = 0; x < volume.resolution.x - 1; x++ )
            {
                ...
                for ( var j = 0; lut.edgeID[index][j] != -1; j += 3 )
                {
                    ...
                    var C = new THREE.Color().setHex( cmap[ colors ][1] );
    ...
    function interpolated_vertex( v0, v1, s )
    {
        ...
        var index_v0 = v0.x + ( v0.y * volume.resolution.x ) + ( v0.z * ( volume.resolution.x * volume.resolution.y ));
        var index_v1 = v1.x + ( v1.y * volume.resolution.x ) + ( v1.z * ( volume.resolution.x * volume.resolution.y ));
